...
export default function CourseDescription({ coursedetails }: CourseDescriptionProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        <div className="space-y-2">
          <h2 className="text-xl sm:text-2xl font-semibold">{coursedetails.name}</h2>
          ...
          <a  className="bg-[#1BC2C2] py-2 px-4 rounded-full hover:bg-[#1bc2c2bd] text-white w-full sm:w-auto" href={coursedetails.meeting_link} target="_blank" rel="noopener noreferrer">
            Join Class
          </a>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="bg-gray-50 border-gray-200 rounded-md p-4">
          <p className="text-sm text-gray-700">{truncateText(coursedetails.description, 150)}</p>
          <Button
            variant="link"
      ...
      <CourseDescriptionModal
        ...
        description={truncateText(coursedetails.description, 150)}
      />
    </div>
  )
}