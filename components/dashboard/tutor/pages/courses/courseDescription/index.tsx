...
const COURSE_DESCRIPTION = `This comprehensive Basic Science course is designed for Grade 6 tutors, covering fundamental concepts in physics, chemistry, and biology. The course emphasizes hands-on experiments and practical applications.
...
Tutors will participate in weekly laboratory sessions and group discussions to reinforce their understanding of scientific concepts.`

const LEARNING_OUTCOMES = `Upon completion, tutors will be able to:
