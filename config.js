  ...
  routes: {
    ...
    dashboard: {
      ...
      admin: {
        ...
        tutorinformation: "/admin/admininformation",
        guardianinformation: "/admin/guardianinformation",
        tutorprofilesettings: "/admin/settings",
        tutorticketlist: "/admin/ticketlist",
        tutorcreateticket: "/admin/createticket",
        tutorticketdetails: "/admin/ticketdetails",
        tutorMakePayment: "/admin/makepayment",
        tutorPaymentHistory: "/admin/paymenthistory",
        tutorTransactionDetails: "/admin/transactiondetails",
      },
    },
  },
}
